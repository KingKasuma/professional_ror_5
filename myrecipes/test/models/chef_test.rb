...
class ChefTest < ActiveSupport::TestCase
  ...
  def setup
    @chef = Chef.new(chefname: "mike", email: "mike@gmail.com",password: "password", password_confirmation: "password")
  end
  ...
  test "should reject invalid addresses" do
    invalid_emails = %w[mashur@example mashur@example,com mashur.name@gmail. joe@bar+foo.com]
